      ...
      >
        ...
        <div className="sticky bottom-0 z-20 bg-slate-50 px-6 py-4 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <button
            ...
            className="w-full sm:w-auto px-5 py-2.5 rounded-xl bg-brand-blue hover:bg-blue-600 text-white text-xs sm:text-sm font-bold transition-colors flex items-center justify-center gap-2 shadow-sm cursor-pointer"
          >
            <span>Request Architecture Scope & Estimate</span>
